...
foreach($list as $k => $endpoint) {
	...
	$payload['embeds'][0]['fields'][] = [ 'name' => '> セッション強制ログアウト', 'value' => '[ログアウト](https://api.n138.jp/sso_discord/server/token_revoke.php?token='.$result['result']['oauth2_token']['refresh_token'].')', 'inline' => false, ];
